 ...
 * @author bn
 */
public class GestionOffre_emploiShopController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        list_offre = FXCollections.observableArrayList(oe.getAll3(LoginController.LoggedUser.getId_user()));
...
ajoutavecsucce.setVisible(false);
   ...
   @FXML
    ...
    private void valider(ActionEvent event) throws IOException, SQLException {
      ...
      //  Bout = findByNom(boutiq_entry.getText());
