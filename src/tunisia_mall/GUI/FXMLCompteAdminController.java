 ...
 * @author ASUS
 */
public class FXMLCompteAdminController implements Initializable {
                        ...
                        if (cj.testpassword(password_txt.getText())) {
                            if (cj.GSM(numerotel_txt.getText())) {
                                if (cj.mailformat(mail_txt.getText())) {
                                    ...
                                    LoginController.LoggedUser.setNom(nom_txt.getText());
                                    LoginController.LoggedUser.setPrenom(prenom_txt.getText());
                                    ...
                                    //u.setId_user(LoginController.LoggedUser.getId_user());
    ...
    void afficher() {
        nom_txt.setText(LoginController.LoggedUser.getNom());
        prenom_txt.setText(LoginController.LoggedUser.getPrenom());
