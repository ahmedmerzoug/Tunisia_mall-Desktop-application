 ...
 * @author ASUS
 */
public class FXMLGestionReclamationCPController implements Initializable {
    ...
    @FXML
    private TableColumn<Reclamation, Integer> tblclmid;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        afficherR(LoginController.LoggedUser);

        type_combo.setItems(comboListtype);
        IReclamationService irs = new ReclamationService();
        id_combo.setItems(irs.displayallclientNameCP());
    ...
    void afficherR(User u) {
        IReclamationService irs = new ReclamationService();

        tblreclamation.setItems(irs.displayallR(u.getId_user()));
...
//        id.setText(String.valueOf(p.getId_pub()));
    ...
    void filterReclamationList(String oldValue, String newValue) {
        ...
        if (txtPesquisar.getText() == null || (newValue.length() < oldValue.length()) || newValue == null) {
            tblreclamation.setItems(irs.displayallR(LoginController.LoggedUser.getId_user()));
